...
public class BackroomsMod implements ModInitializer {
	...
	private static final List<Radio.RadioRecord> records = Arrays.asList(
			...
			new Radio.RadioRecord(Text.translatable("item.backrooms.orbit_tape.desc").getString(), ModSounds.ORBIT),
			new Radio.RadioRecord(Text.translatable("item.backrooms.slingshot_tape.desc").getString(), ModSounds.SLINGSHOT),
