...
public class ModItems {
    ...
    // weapons
    public static final Item WRENCH = registerItem("wrench", new LibuWeapon.LibuSword(6.5f, 1.6f, 835, new Item.Settings().group(BackroomsItemsGroup.Weapons)));
    public static final Item CROWBAR = registerItem("crowbar", new LibuWeapon.LibuSword(8.0f, 1.6f, 2051, new Item.Settings().group(BackroomsItemsGroup.Weapons)));
    public static final Item SHARPENED_KNIFE = registerItem("sharpened_knife", new LibuWeapon.LibuSword(6.5f, 1.3f, 130, new Item.Settings().group(BackroomsItemsGroup.Weapons)));
    public static final Item NAILED_BAT = registerItem("nailed_bat", new LibuWeapon.LibuSword(7.0f, 1.8f, 515, new Item.Settings().group(BackroomsItemsGroup.Weapons)));
    public static final Item BASEBALL_BAT = registerItem("baseball_bat", new LibuWeapon.LibuSword(2.5f, 1.8f, 481, new Item.Settings().group(BackroomsItemsGroup.Weapons)));
    public static final Item BROKEN_BOTTLE = registerItem("broken_bottle", new LibuWeapon.LibuSword(1.5f, 0.8f, 3, new Item.Settings().group(BackroomsItemsGroup.Weapons)));
