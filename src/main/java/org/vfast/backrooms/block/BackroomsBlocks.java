...
public class BackroomsBlocks {
    ...
    public static final Block MOIST_SILK = registerBlock("moist_silk",
            new Block(QuiltBlockSettings.copyOf(Blocks.OAK_WOOD).sounds(BlockSoundGroup.WOOD).requiresTool().strength(2f)), BackroomsItemsGroup.MAIN, ItemGroups.BUILDING_BLOCKS);
    public static final Block MOIST_SILK_PLANKS = registerBlock("moist_silk_planks",
            new Block(QuiltBlockSettings.copyOf(Blocks.OAK_WOOD).sounds(BlockSoundGroup.WOOD).strength(2f)), BackroomsItemsGroup.MAIN, ItemGroups.BUILDING_BLOCKS);
    public static final Block MOIST_CARPET = registerBlock("moist_carpet",
            new Block(QuiltBlockSettings.copyOf(Blocks.WHITE_WOOL).sounds(BlockSoundGroup.WOOL).requiresTool().strength(2f)), BackroomsItemsGroup.MAIN, ItemGroups.BUILDING_BLOCKS);
    public static final Block DROPPED_CEILING = registerBlock("dropped_ceiling",
            new Block(QuiltBlockSettings.copyOf(Blocks.WHITE_WOOL).sounds(BlockSoundGroup.WOOL).strength(1f)), BackroomsItemsGroup.MAIN, ItemGroups.BUILDING_BLOCKS);
    public static final Block FLUORESCENT_LIGHT = registerBlock("fluorescent_light",
            new FluorescentLight(QuiltBlockSettings.copyOf(Blocks.GLASS).sounds(BlockSoundGroup.GLASS).strength(0.1f).luminance(9)), BackroomsItemsGroup.MAIN, ItemGroups.BUILDING_BLOCKS);
    public static final Block LEVEL_ZERO_PORTAl = registerBlock("level_zero_portal",
            new LevelZeroPortalBlock(QuiltBlockSettings.copyOf(Blocks.NETHER_PORTAL).luminance(15).breakInstantly()), BackroomsItemsGroup.MAIN, ItemGroups.FUNCTIONAL);

    // Level 1
    public static final Block SMOOTH_IRON = registerBlock("smooth_iron_block",
            new Block(QuiltBlockSettings.copyOf(Blocks.IRON_BLOCK).sounds(BlockSoundGroup.METAL).strength(Blocks.IRON_BLOCK.getHardness())), BackroomsItemsGroup.MAIN, ItemGroups.BUILDING_BLOCKS);
    public static final Block SCRATCHED_CONCRETE = registerBlock("slightly_scratched_concrete",
            new Block(QuiltBlockSettings.copyOf(Blocks.STONE).sounds(BlockSoundGroup.STONE).strength(Blocks.BLACK_CONCRETE.getHardness())), BackroomsItemsGroup.MAIN, ItemGroups.BUILDING_BLOCKS);
    ...
    public static final Block STREET_LIGHT = registerBlock("street_light",
            new Block(QuiltBlockSettings.copyOf(Blocks.GLASS).sounds(BlockSoundGroup.GLASS).strength(0.1f).luminance(15)), BackroomsItemsGroup.MAIN, ItemGroups.BUILDING_BLOCKS);

    // Level Run
    public static final Block HOSPITAL_DOOR = registerBlock("hospital_door", new DoorBlock(QuiltBlockSettings.copyOf(Blocks.IRON_DOOR), BlockSetTypeBuilder.copyOf(BlockSetType.IRON).openableByHand(true).build(new Identifier(BackroomsMod.ID, "ceramic"))), BackroomsItemsGroup.MAIN, ItemGroups.BUILDING_BLOCKS);

    // Other

    public static final Block TAPE_PLAYER = registerBlock("tape_player",
            new TapePlayer(QuiltBlockSettings.copyOf(Blocks.IRON_BLOCK).sounds(BlockSoundGroup.STONE).strength(Blocks.IRON_BLOCK.getHardness()).requiresTool().nonOpaque()), BackroomsItemsGroup.MAIN, ItemGroups.FUNCTIONAL);
    public static final Block RADIO = registerBlock("radio",
            new Radio(QuiltBlockSettings.copyOf(Blocks.STONE).sounds(BlockSoundGroup.STONE).strength(Blocks.IRON_BLOCK.getHardness()).requiresTool().nonOpaque()), BackroomsItemsGroup.MAIN, ItemGroups.FUNCTIONAL);
